            ...
            <div className='main'>
                ...
                <div className={styles.FormDiv}>
                    <form id="ModifyForm" method="POST" >
                        ...
                        <input type="text" className={styles.title} ref={titleRef} value={title} onChange={handleTitle} />
                        <textarea className={styles.content} cols="100" rows="500" ref={contentRef} value={content} onChange={handleContent}></textarea>
                        ...
                        <div className={styles.fileuploadForm}>
                            ...
                            statusbarState.map((statusbar)=> ( statusbar.filename &&
                                <div className={styles.statusbar} key={statusbar.filenum}>
                        ...
                        <input type="button" className={styles.btn_modify} value="수정" onClick={handleModify} />
